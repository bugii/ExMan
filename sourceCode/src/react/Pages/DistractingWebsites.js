...
function DistractingWebsites() {
  ...
  useEffect(() => {
    ipcRenderer.on("distracting-websites", (e, array) => {
      setDisArray(array);
    });
    ipcRenderer.send("distracting-websites");
  }, []);

  return (
    <DistApp>
      <h1> Distracting Websites</h1>
      <Button
      ...
      <h4>Number of distracting websites: {disArray.length}</h4>
...
export default DistractingWebsites;

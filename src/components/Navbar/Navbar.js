    ...
    return (
        <NavbarDiv>
            <Tooltip title="home" arrow placement="right">
                <HomeIcon onClick={handleHomeClick} style={{color: Colors.snow, fontSize: 50, margin: "0.5rem 1rem"}}/>
            </Tooltip>
            <div>
                ...
                <div style={{display: "flex", flexDirection: "column-reverse", height: "100%"}}>
                    <Tooltip title="settings" arrow placement="right">
                        <SettingsIcon style={{color: Colors.snow, fontSize: 50, margin: "0.5rem 1rem", position: "absolute", top: "90%"}}/>
                    </Tooltip>
                    <Tooltip title="add app" arrow placement="right">
                        <AddCircleOutlineIcon style={{color: Colors.snow, fontSize: 50, margin: "0.5rem 1rem", position: "absolute", top: "80%"}}/>
                    </Tooltip>
                </div>
            </div>
        </NavbarDiv>
